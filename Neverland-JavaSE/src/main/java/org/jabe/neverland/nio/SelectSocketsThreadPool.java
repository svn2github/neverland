...
public class SelectSocketsThreadPool extends SelectSockets {
	 ...
	 * 147 been drained, the worker thread returns itself to its parent pool.
	 */
	private class WorkerThread extends Thread {
		...
		/**
		 * 148 The actual code which drains the channel associated with the
		 * given key. This method assumes the key has been modified prior to
