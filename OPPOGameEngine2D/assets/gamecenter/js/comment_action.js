...
function callSend() {
	...
	if (content.trim() == ""
			|| content == (nearmelang.lang_comment_inittext + nearmelang.lang_global_word140)) {
		opalert(nearmelang.lang_comment_message_null);
		return;
	}
	$.action({
				callback : function(data) {
					...
					// }
					// });
					android.makeToast(nearmelang.lang_comment_message_success);
					android.goBack();
				},
				Action : {
					"currentHtml" : "comment.html",
