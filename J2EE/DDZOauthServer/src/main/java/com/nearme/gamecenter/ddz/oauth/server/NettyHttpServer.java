...
import com.nearme.gamecenter.ddz.oauth.timeout.HttpHeartbeatHandler;
...
public class NettyHttpServer extends AbstractNettyServer {
	 ...
	 * @return
	 */
	protected ChannelPipeline getChannelPipeline(Executor handlerExecutor) {
	 ...
	 * @return
	 */
	protected SimpleChannelUpstreamHandler getHttpServerHandler(final Executor handlerExecutor) {
