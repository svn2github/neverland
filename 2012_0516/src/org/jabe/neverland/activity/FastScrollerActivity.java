...
public class FastScrollerActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.act_fastscroller_main);

		this.overlay = (TextView) View.inflate(this, R.layout.act_fastscroller_overlay, null);
		getWindowManager()
				.addView(
						overlay,
		...
		listView.setAdapter(new BaseAdapter() {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				TextView textView = new TextView(FastScrollerActivity.this);
